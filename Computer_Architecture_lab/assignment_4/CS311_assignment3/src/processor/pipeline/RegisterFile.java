...
public class RegisterFile {
	...
	public int getFreezedprogramCounter()
	{
		return freezedprogramCounter;
	}

	public void setFreezedprogramCounter(int freezedprogramCounter)
	{
		this.freezedprogramCounter = freezedprogramCounter;
	}
	...
	public void setFreezed(boolean truth) {
		this.freeze = truth;
	}
