...
public class Processor {
	...
	public Processor()
	{
		...
		icache = new Cache(this,8,1024);
		dcache = new Cache(this,3,512);
		IFUnit = new InstructionFetch(this, IF_EnableLatch, IF_OF_Latch, EX_IF_Latch, icache);
		...
		MAUnit = new MemoryAccess(this, EX_MA_Latch, MA_RW_Latch, dcache);
