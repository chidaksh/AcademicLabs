...
public class Cache implements Element {
    ...
    public int cacheRead(int address) {
        ...
        if (temp == 0)
            ...
            temp_ind = Integer.parseInt(a.substring(a.length() - temp - 1, a.length() - 2),2);

        System.out.println("in the Cache " + address);
        System.out.println("index: "+temp_ind);  
        int add_tag = Integer.parseInt(a.substring(0, a.length() - temp - 2), 2);
    ...
    public void cacheWrite(int address, int value) {
        ...
        if (temp == 0)
            ...
            temp_ind = Integer.parseInt(a.substring(a.length() - temp - 1, a.length() - 2),2);
        int tag = Integer.parseInt(a.substring(0, a.length() - temp - 2), 2);
