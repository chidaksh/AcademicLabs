class Tree:
  def __init__(self,abs,ord,h,d,w,val,up_x=0,up_y=0,down_x=0,down_y=0,right_x=0,right_y=0,left_x=0,left_y=0,value_up=0,value_down=0,value_right=0,value_left=0,right=False,left=False,up=False,down=False):
    self.x=abs
    self.y = ord
    self.height = h
    self.time_taken = d
...
def value_update(ls):
  for i in range(len(ls)):
    if ls[i].up == True:
      ...
      while (a.up==True):
        fresh = ls[:]
        b = next((t for t in fresh if (t.x == a.x_up and t.y == a.y_up)),a)
        if b==a:
          break;
        temp.append(b.value)
        a = b
    ...
    if ls[i].down == True:
      ...
      while (a.down==True):
        fresh = ls[:]
        b = next((t for t in fresh if (t.x == a.x_down and t.y == a.y_down)),a)
        if b==a:
          break;
        temp.append(b.value)
        a = b
    ...
    if ls[i].right == True:
      ...
      while (a.right==True):
        fresh = ls[:]
        b = next((t for t in fresh if (t.x == a.x_right and t.y == a.y_right)),a)
        if b==a:
          break;
        temp.append(b.value)
        a = b
    ...
    if ls[i].left == True:
      ...
      while (a.left ==True):
        fresh = ls[:]
        b = next((t for t in fresh if (t.x == a.x_left and t.y == a.y_left)),a)
        if b==a:
          break;
        temp.append(b.value)
        a = b
...
def final_value_update(ls):
  for x in ls:
    x.value = max(x.value,x.up_value,x.down_value,x.right_value,x.left_value)
        ...
        if search[0].up == True or search[0].down == True or search[0].right == True or search[0].left==True:
           ...
           if a.finaldir == "up":
              while (a.up==True):
                new = search[:]
                #new.remove(a)
                b = next((t for t in new if (t.x == a.x_up and t.y == a.y_up)),a)
                #print("------------------------------------------------")
                if b==a:
                  break;
                a = b
           ...
           if a.finaldir == "down":
              while (a.down==True):
                new = search[:]
                #new.remove(a)
                b = next((t for t in new if (t.x == a.x_down and t.y == a.y_down)),a)
                #print("------------------------------------------------")
                if b==a:
                  break;
                a = b
           ...
           if a.finaldir == "right":
              while a.right==True:
                new = search[:]
                #new.remove(a)
                b = next ((t for t in new if (t.x == a.x_right and t.y == a.y_right)),a)
                #print("------------------------------------------------")
                if b==a:
                  break;
                a = b
           ...
           if a.finaldir == "left":
              while (a.left ==True):
                new = search[:]
                #new.remove(a)
                b = next((t for t in new if (t.x == a.x_left and t.y == a.y_left)),a)
                #print("------------------------------------------------")
                if b==a:
                  break;
                a = b
